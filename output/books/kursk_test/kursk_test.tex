% BattleGroup North Africa - Kursk\_Test
...
\hypersetup{
  ...
  pdftitle={Kursk\_Test - BattleGroup North Africa},
  pdfauthor={Generated from Primary Sources}
}

% Document metadata
\title{Kursk\_Test - BattleGroup North Africa}
...
\begin{titlepage}
  ...
  {\Huge\bfseries Kursk\_Test - BattleGroup North Africa\par}
  \vspace{0.5cm}
  {\Large Historical Scenarios and Army Lists\par}
  \vspace{2cm}

  {\large Kursk\_Test\par}
  {\large July 5-16, 1943\par}
  \vspace{1cm}
...
This book contains historically accurate scenarios and army lists for Kursk\_Test.
...
Placeholder for 12 historical scenarios.
