...
def main():
    ...
    print(f"Found {len(equipment_sections)} pages with equipment keywords")
    ...
    for section in equipment_sections[:15]:
        ...
        print(f"Processing page {page_num} (keywords: {section['keyword_count']})...")
    ...
    print(f"Raw extraction saved to: {raw_file}")
