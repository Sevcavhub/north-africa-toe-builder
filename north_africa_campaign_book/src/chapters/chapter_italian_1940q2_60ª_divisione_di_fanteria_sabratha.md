# 60ª Divisione di Fanteria 'Sabratha' Division
...
**[MANUAL: Add 2-3 paragraphs of historical context about the 60ª Divisione di Fanteria 'Sabratha']**

**[MANUAL: Describe the unit's role during 1940-Q2, formation history, and strategic importance]**

**[MANUAL: Add operational context - what major operations/battles occurred this quarter]**

**Key Statistics (1940-Q2):**
- Total Strength: 12,800 personnel
- Unit Type: auto-transportable_infantry
- Organization Level: Division
- Parent Formation: Unknown
- Commander: None None
- Headquarters Location: Gharyan, Libya
- Artillery: 36 guns
- Motor Vehicles: 285
...
Division headquarters was established at: Gharyan, Libya
...
### Officer Corps: 640 Officers (5.0% of total)
...
### Non-Commissioned Officers: 1,920 NCOs (15.0% of total)
...
### Enlisted Personnel: 10,240 (80.0% of total)
...
- Note: Regiment renamed 'Sabratha' in 1939. Each battalion: 4 rifle companies + 1 machine gun company + 1 mortar platoon.
...
- Type: Unknown
- Strength: 0 personnel
- Note: Standard Italian divisional artillery organization. Mixed calibers for flexibility.

**4. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Divisional anti-tank company. 47mm guns effective against light armor only.

**5. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Division-level engineers. Responsible for field fortifications, mine warfare, and mobility support.

**6. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Division signals. Limited radio equipment - relied heavily on wire communications.

**7. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: MVSN (Fascist Militia) legion attached to division. Provided additional infantry but lower combat effectiveness than regular infantry.

**8. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Division medical services. Limited capacity - serious casualties evacuated to Tripoli.

**9. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Division supply and logistics. Operated supply dumps at Gharyan.

**10. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Military police. Traffic control, prisoner handling, rear area security.

**11. Unknown Unit**
- Type: Unknown
- Strength: 0 personnel
- Note: Ceremonial and morale purposes.
...
**[MANUAL: Add rifle, machine gun, and other infantry weapons with specifications and counts]**

## 6. Motor Vehicles and Transport

### Total Motor Vehicles: 285
...
**[MANUAL: Add operational radius estimate with limiting factors]**
