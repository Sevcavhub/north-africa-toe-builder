...
// Output CSV
console.log('YYYY-QQ,Nation,Unit');
incomplete.forEach(item => {
  const escapedUnit = item.designation.includes(',') ? `"${item.designation}"` : item.designation;
  console.log(`${item.quarter},${item.nation},${escapedUnit}`);
});
