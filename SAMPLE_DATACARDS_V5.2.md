# Sample Datacards v5.2 - Print Test

**Demonstrates fixes:**
- Weapons extracted from `bg_reference_vehicles.weapon_1-4`
- Ammo counts from `bg_reference_vehicles.ammo_1-4`
- Weapon performance tables with calculated HE/AP values
...
def main():
    """Main execution function.<div class="datacard-grid">
...
<div class="datacard-title-block">
<p class="datacard-title">CRUSADER I</p>
<p class="datacard-subtitle">1940-1945 | Tank</p>
<p class="datacard-special-rules">British Resolve, Desert Adapted, Fast</p>
</div>
</div>
...
<div class="datacard-title-block">
<p class="datacard-title">PANZER I</p>
<p class="datacard-subtitle">1940-1945 | Tank</p>
<p class="datacard-special-rules">Desert Adapted, German Tactical Doctrine, Hull MG, Smoke Dischargers, Thin Armor, Tracked</p>
</div>
</div>
