...
# Step 1: Check earliest backup for ammo data in special_rules
print("\n📋 Step 1: Checking earliest backup for ammo data...")

# Use the earliest backup that still has special_rules
backup_table = "bg_reference_vehicles_backup_20251107_222712"
print(f"   Using backup: {backup_table}")
