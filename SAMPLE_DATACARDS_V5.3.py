#!/usr/bin/env python3
"""
Generate sample datacards v5.3 for print testing
V5.3 changes:
- Title uses bg_builder_vehicles.name (instead of datacard_name)
- Year range on separate line
- dc_meta on third line
"""
...
from scripts.battlegroup.book.generate_book_datacards_v5_3 import BookDatacardGenerator
...
def generate_sample():
    ...
    output_file = project_root / "SAMPLE_DATACARDS_V5.3.html"

    with open(output_file, 'w', encoding='utf-8') as f:
        # Write HTML header
        f.write("<!DOCTYPE html>\n<html>\n<head>\n")
        f.write("<meta charset='UTF-8'>\n")
        f.write("<title>Sample Datacards v5.3 - Print Test</title>\n")

        # Write CSS (extract from actual generator to ensure consistency)
        import re
        gen_path = project_root / "scripts" / "battlegroup" / "book" / "generate_book_datacards_v5_3.py"
