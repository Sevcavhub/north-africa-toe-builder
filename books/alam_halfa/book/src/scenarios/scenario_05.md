...
Part of Battle of Alam Halfa operation.
## THE BATTLE
German 15th Panzer Division launches dawn counterattack to retake Fort Capuzzo from British 4th Armoured Brigade. Combined arms assault with Panzer IIIs, infantry, and artillery support.

**German Objective**: Recapture fort by turn 10

**British Objective**: Hold fort OR destroy 50% German tanks
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Fort with stone walls
- **terrain**: trenches
- **terrain**: barbed wire
- **terrain**: open desert approaches
...
**German Victory**: Recapture fort by turn 10

**British Victory**: Hold fort OR destroy 50% German tanks

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**German**: German deploy within 12" of south table edge

**British**: British deploy within 12" of north table edge
...
**Units**:
- 22x Panzer III (veteran) - 1100 pts, BR: 7 [2 companies]
- 5x German Panzergrenadier Company (veteran) - 1550 pts, BR: 5 [2 companies, 170 men]
...
**Units**:
- 9x Matilda II (veteran) - 450 pts, BR: 3 [1 squadron]
- 5x Infantry Company (veteran) - 800 pts, BR: 5 [2 companies, 170 men]
...
These forces represent elements of **15. Panzer-Division** (Deutsches Afrika Korps, Panzerarmee Afrika).
