...
\fancyhead[RE]{Operation Crusader}
...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\Huge\bfseries Operation Crusader\par}
    \vspace{1cm}
    {\Large November-December 1941 - The Largest Desert Battle\par}
    \vspace{2cm}
