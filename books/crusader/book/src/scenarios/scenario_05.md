...
**German Objective**: Destroy British forces at Sidi Rezegh (60%+ casualties all British units)
## THE BATTLEFIELD
**Table Size**: 8' × 6'

**Terrain**:
- **terrain**: Sidi Rezegh escarpment with ridges
- **terrain**: airfield
- **terrain**: scattered defensive positions
...
**German Victory**: Destroy British forces at Sidi Rezegh (60%+ casualties all British units)

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**British/SA**: British/SA deploy within 12" of south table edge
