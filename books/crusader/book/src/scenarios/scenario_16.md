...
**British Objective**: Retake Sidi Rezegh positions

**German Objective**: Hold against renewed attack (depleted forces)
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Previous battlefield with wrecked tanks
- **terrain**: destroyed equipment
- **terrain**: shell craters
- **terrain**: German defensive positions
...
**British Victory**: Retake Sidi Rezegh positions

**German Victory**: Hold against renewed attack (depleted forces)
