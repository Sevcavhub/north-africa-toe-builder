...
**British Objective**: Break through and advance 2 table sections toward Ed Duda

**German Objective**: Hold siege line OR inflict 50% casualties
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Axis siege lines with minefields
- **terrain**: barbed wire
- **terrain**: trenches
...
**British Victory**: Break through and advance 2 table sections toward Ed Duda

**German Victory**: Hold siege line OR inflict 50% casualties
