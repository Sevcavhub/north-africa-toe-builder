...
**South African Objective**: Advance and capture Axis positions

**Italian Objective**: Hold positions OR conduct fighting withdrawal
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Tel el Eisa positions with trenches
- **terrain**: some rocky ground
...
**South African Victory**: Advance and capture Axis positions

**Italian Victory**: Hold positions OR conduct fighting withdrawal

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**South African**: South African deploy within 12" of south table edge
