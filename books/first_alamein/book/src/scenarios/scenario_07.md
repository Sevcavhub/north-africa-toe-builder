...
**British Objective**: Advance through depression (unaware of trap)

**Axis Objective**: Destroy British armor (60%+ casualties)
## THE BATTLEFIELD
**Table Size**: 8' × 4'
...
**British Victory**: Advance through depression (unaware of trap)

**Axis Victory**: Destroy British armor (60%+ casualties)
...
**Units**:
- 1x Mixed Force (veteran) - 1100 pts, BR: 55 [Defensive screen (1 battery 88mm 4-6 guns, 2 batteries PAK 40 75mm 8-12 guns, 1 company Panzer III/I...]
