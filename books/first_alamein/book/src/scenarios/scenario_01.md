...
**Indian Objective**: Hold box OR delay Germans 8+ turns

**German Objective**: Capture box by nightfall (10 turns)
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Fortified box with trenches
- **terrain**: minefields
- **terrain**: barbed wire
...
**Indian Victory**: Hold box OR delay Germans 8+ turns

**German Victory**: Capture box by nightfall (10 turns)

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**Indian**: Indian deploy within 12" of south table edge
...
**Units**:
- 14x Infantry Battalion (veteran) - 2240 pts, BR: 14 [1 battalion, 425 men (~14 platoons)]
- 4x 25-pdr (8-12 guns) (veteran) - 200 pts, BR: 1 [1 battery (4 guns per battery assumed)]
- 4x 2-pdr AT (6-8 guns) (veteran) - 200 pts, BR: 1 [1 battery (4 guns per battery assumed)]
...
**Units**:
- 18x Infantry Battalion (veteran) - 5580 pts, BR: 18 [2 battalion, 550 men (~18 platoons)]
- 4x 88mm (veteran) - 200 pts, BR: 1 [1 battery/section]
