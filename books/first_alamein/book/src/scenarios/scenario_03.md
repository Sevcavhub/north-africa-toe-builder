...
**Australian Objective**: Capture Point 63 and surrounding positions

**Axis Objective**: Hold positions OR counterattack
## THE BATTLEFIELD
**Table Size**: 6' × 4'

**Terrain**:
- **terrain**: Tel el Eisa ridge with defensive positions
- **terrain**: some buildings
...
**Australian Victory**: Capture Point 63 and surrounding positions

**Axis Victory**: Hold positions OR counterattack

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**Australian**: Australian deploy within 12" of south table edge
