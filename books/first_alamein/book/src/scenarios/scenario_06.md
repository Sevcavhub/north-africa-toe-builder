...
**British/NZ/Indian Objective**: 

**Axis Objective**: Hold ridge
## THE BATTLEFIELD
**Table Size**: 8' × 4'
...
**British/NZ/Indian Victory**: 

**Axis Victory**: Hold ridge

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**British/NZ/Indian**: British/NZ/Indian deploy within 12" of south table edge
...
- 22x Valentine/Grant (veteran) - 1100 pts, BR: 7 [Informal range]
