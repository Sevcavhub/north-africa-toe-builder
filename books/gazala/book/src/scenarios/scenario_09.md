...
**British Objective**: Break out (exit 60%+ force off table toward Egypt)

**German Objective**: Block retreat (destroy/capture British forces)
## THE BATTLEFIELD
**Table Size**: 6' × 4'
...
**British Victory**: Break out (exit 60%+ force off table toward Egypt)

**German Victory**: Block retreat (destroy/capture British forces)
...
**Units**:
- 1x Mixed Force (veteran) - 900 pts, BR: 45 [Mixed breakout force (1 company infantry, 1 squadron tanks 8-10, various support units, supply truck...]
