...
**British Objective**: Conduct orderly withdrawal (exit 60%+ force)

**German Objective**: Inflict maximum casualties (destroy 50%+ British)
## THE BATTLEFIELD
**Table Size**: 8' × 4'
...
**British Victory**: Conduct orderly withdrawal (exit 60%+ force)

**German Victory**: Inflict maximum casualties (destroy 50%+ British)
...
**Units**:
- 24x tanks (veteran) - 1200 pts, BR: 8 [2 squadron (~12/squadron assumed)]
