...
**British Objective**: Break through German defenses

**German Objective**: Destroy British armor (50%+ casualties)
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Open desert
- **terrain**: German AT guns in hull-down positions
...
**British Victory**: Break through German defenses

**German Victory**: Destroy British armor (50%+ casualties)
...
**Units**:
- 1x Mixed Force (veteran) - 1350 pts, BR: 67 [2-3 squadrons (24-30 tanks: Grant, Crusader), reduced strength from previous battles...]

### GERMAN FORCES
**Nation**: German
**Points Budget**: 1350
**Total Battle Rating**: 14

**Units**:
- 4x 88mm FlaK (veteran) - 380 pts, BR: 8 [1 battery/section]
- 6x PAK 38 (veteran) - 270 pts, BR: 6 [1 battery/section]
