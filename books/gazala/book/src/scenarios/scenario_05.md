# 25. Bir Hacheim - The Grinding Siege
## SITUATION REPORT
...
**Free French Objective**: Hold until ordered to withdraw (survive with 30%+ force)

**Axis Objective**: Capture fort OR force surrender (reduce French morale)
## THE BATTLEFIELD
**Table Size**: 6' × 4'

**Terrain**:
- **terrain**: Battered fortifications (previous damage from Day 1
- **terrain**: collapsed trenches
- **terrain**: crater-marked)
...
**Free French Victory**: Hold until ordered to withdraw (survive with 30%+ force)

**Axis Victory**: Capture fort OR force surrender (reduce French morale)

**Draw**: Neither side achieves their objectives

## DEPLOYMENT
**Free French**: Free French deploy within 12" of south table edge
...
**Units**:
- 1x Mixed Force (veteran) - 900 pts, BR: 45 [Garrison (depleted, 70% strength from Day 1, limited ammunition/water)...]
