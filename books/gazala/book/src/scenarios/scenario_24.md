...
**Free French Objective**: Hold positions, inflict casualties on attackers

**Axis Objective**: Capture fort or inflict 40% casualties
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Fortified position with trenches
- **terrain**: dugouts
- **terrain**: minefields
- **terrain**: barbed wire
...
**Free French Victory**: Hold positions, inflict casualties on attackers

**Axis Victory**: Capture fort or inflict 40% casualties
