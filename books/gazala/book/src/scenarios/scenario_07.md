...
**British Objective**: Destroy German armor (60%+ tank casualties)

**German Objective**: Destroy British armor (60%+ tank casualties)
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Open desert with Knightsbridge box visible
...
**British Victory**: Destroy German armor (60%+ tank casualties)

**German Victory**: Destroy British armor (60%+ tank casualties)
...
**Units**:
- 1x Mixed Force (veteran) - 1350 pts, BR: 67 [2+ companies (24-28 tanks: Panzer III Ausf J long 50mm, Panzer IV F2 long 75mm, Panzer II), 1 compan...]
