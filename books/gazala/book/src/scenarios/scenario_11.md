...
**German Objective**: Breach perimeter and advance into Tobruk

**British/SA Objective**: 
## THE BATTLEFIELD
**Table Size**: 8' × 4'

**Terrain**:
- **terrain**: Tobruk perimeter with anti-tank ditch
- **terrain**: minefields
...
**German Victory**: Breach perimeter and advance into Tobruk
...
**British/SA**: British/SA deploy within 12" of north table edge
...
**Units**:
- 1x Mixed Force (veteran) - 1100 pts, BR: 55 [Assault force (2 battalions Panzergrenadiers, 2 companies Panzer III/IV, engineers, Stuka air suppor...]
...
**Units**:
- 1x Mixed Force (veteran) - 1100 pts, BR: 55 [Defense force (2 battalions South African infantry, 1 battery 25-pdr, prepared defenses but weak gar...]
